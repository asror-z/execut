...
#include <MyUDFs\JSON.au3>
#include <MyUDFs\WinHttp.au3>
...
#ce ===============================================================================
    Func _CreateInlineKeyboard(ByRef $Keyboard)
        ...
        Return $jsonKeyboard
    EndFunc   ;==>_CreateInlineKeyboard

#EndRegion "@BOT MAIN FUNCTIONS"
...
#EndRegion "@SEND AND MEDIA FUNCTIONS"
